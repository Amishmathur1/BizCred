...
export async function loader() {
  try {
    ...
    if (data.status === "success") {
      ...
      // Filter for high-risk proposals (risk >= 75)
      const highRiskProposals = latestProposals.filter(
        (p: Proposal) => p.risk_percentage >= 75
      );
      
      // Get the first high-risk proposal
      const proposal = highRiskProposals[0] || null;
        ...
        <div className="flex flex-col gap-5 w-full">
          ...
          {loading ? (
            ...
            <div className="bg-red-900 text-white p-4 rounded-lg">
              <p className="font-bold">No high-risk proposals available</p>
