...
export async function loader() {
  try {
    ...
    if (data.status === "success") {
      ...
      // Filter for medium-risk proposals (50 <= risk < 75)
      const mediumRiskProposals = latestProposals.filter(
        (p: Proposal) => p.risk_percentage >= 50 && p.risk_percentage < 75
      );
      
      // Get the first medium-risk proposal
      const proposal = mediumRiskProposals[0] || null;
        ...
        <div className="flex flex-col gap-5 w-full">
          ...
          {loading ? (
            ...
            <div className="bg-red-900 text-white p-4 rounded-lg">
              <p className="font-bold">No medium-risk proposals available</p>
